/* Module: NumberTile / File: numbertile.hh
 * Includes the data and functionality of a single tile.
 */
...
public:
    ...
    // Sets the value of the tile back to 0 (empty) the game is reseted.
    void reset_value();
